# ApexGirl Bot State Monitoring System
...
1. **[state_manager.py](state_manager.py)** - Core state management module
...
3. **[ApexGirlBot.py](ApexGirlBot.py)** - Integrated with StateManager
...
from state_manager import get_running_bots_summary
...
### ApexGirlBot Integration

The main bot automatically integrates with StateManager:

1. **Initialization** ([ApexGirlBot.py:1524-1526](ApexGirlBot.py#L1524-L1526))
   ```python
   self.state_manager = StateManager(self.username)
   ```

2. **Checkbox Changes** ([ApexGirlBot.py:1564-1586](ApexGirlBot.py#L1564-L1586))
   - Trace callbacks on all checkbox variables
   - Automatic database update on change

3. **Settings Changes** ([ApexGirlBot.py:1588-1599](ApexGirlBot.py#L1588-L1599))
   - Trace callbacks on all settings
   - Automatic database update on change

4. **Log Updates** ([ApexGirlBot.py:1875-1883](ApexGirlBot.py#L1875-L1883))
...
5. **Heartbeat** ([ApexGirlBot.py:2247-2251](ApexGirlBot.py#L2247-L2251))
   - Called every bot loop iteration
   - Updates `last_update` timestamp
   - Allows detection of stuck/crashed bots

6. **Stop Detection** ([ApexGirlBot.py:1929-1933](ApexGirlBot.py#L1929-L1933))
...
# Terminal 2
python ApexGirlBot.py Gelvil1

# Terminal 3
python ApexGirlBot.py Gelvil2
...
See docstrings in [state_manager.py](state_manager.py) for complete API documentation.
